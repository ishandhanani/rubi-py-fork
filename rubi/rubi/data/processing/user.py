...
class User:
    ...
    def get_user_trading_transactions(
        self,
        user,
        pair=None,
        filled=None,
        ...
        op_offers = self.market_optimism.get_offers(
            maker=user,
            pair=pair,
            filled=filled,
            cancelled=cancelled,
        ...
        op_trades = self.market_optimism.get_trades(
            taker=user,
            pair=pair,
            pay_gem=pay_gem,
            buy_gem=buy_gem,
        ...
        if op_offers.empty:
            op_offers = pd.DataFrame(
                columns=[
                    "offers_maker_id",
                    "offers_transaction_id",
                    "offers_transaction_timestamp",
                ]
            )
        if op_trades.empty:
            op_trades = pd.DataFrame(
                columns=[
                    "takes_taker_id",
                    "takes_transaction_id",
                    "takes_transaction_timestamp",
                ]
            )
        ...
        op_offers = op_offers[
            ["user", "transaction_hash", "transaction_timestamp", "transaction_type"]
        ]
        op_trades = op_trades[
            ["user", "transaction_hash", "transaction_timestamp", "transaction_type"]
        ]
...
class SuperUser(User):
    ...
    def get_user_trading_gas_spend(
        self,
        user,
        pair=None,
        filled=None,
        ...
        df = self.get_user_trading_transactions(
            user,
            pair=pair,
            filled=filled,
            cancelled=cancelled,
