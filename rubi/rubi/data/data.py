...
class Data:
    ...
    def __init__(self, super=False):
        ...
        if not super:
            ...
            self.market_aid_optimism_processing = AidProcessing(
                self.subgrounds, 10, self.market_aid_optimism
            )
            self.market_aid_optimism_goerli_processing = AidProcessing(
                self.subgrounds, 420, self.market_aid_optimism_goerli
            )
...
class SuperData(Data):
    ...
    def __init__(self, w3):
        ...
        if chain == 10:
            ...
            self.market_aid_optimism = AidData(self.subgrounds, 10)
            self.market_aid_optimism_goerli = SuperAidData(
                self.w3, self.subgrounds, 420
            )
